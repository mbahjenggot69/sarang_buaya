...
<head>
    ...
    <title>SIMERA | Daftar Barang Keluar</title>
        ...
        <div class="modal-content">
            ...
            <form method="post" name="myForm" onsubmit="return validateForm()">
                <div class="modal-body">
                    ...
                    <input type="number" name="stock" placeholder="Stock Barang" class="form-control" required><br>
                </div>

                <!-- Modal footer -->
                <div class="modal-footer">
                    <button class="btn btn-success" name="addbrg" type="submit">Tambah Barang</button>
