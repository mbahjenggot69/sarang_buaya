<?php
require '../pages1/function.php';
require '../pages1/cek.php';
...
?>
    ...
    <head>
        ...
        <script>
            function selesaiPesanan(kode) {
                ...
                xhr.open('POST', '../pages1/selesai.php', true);
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark" style="padding-top: 30px; padding-bottom: 35px;">
            <a href="../pages1/main.php"><img src="../assets/img/Logo_SIMERA_2.png" width="80px" alt="Logo" /></a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="../pages1/main.php">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../pages1/manajemen.php">Peralatan Lab</a>
                                    <a class="nav-link" href="../pages1/pemesanan.php">Pemesanan Lab</a>
                                    <a class="nav-link" href="../pages1/history.php">History</a>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $bataswaktu; ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#pesan<?= $idalat; ?>">
                                                        Selesai
                                                    </button>
                                                </td>
                                            </tr>
                                            <!-- The Modal Selesai -->
                                            <div class="modal fade" id="pesan<?= $idalat; ?>">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                Apakah Anda yakin ingin menyelesaikan pesanan <?= $namaalat; ?> dengan kode <?= $kode; ?>?
                                                                <input type="hidden" name="idalat" value="<?= $idalat; ?>">
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="selesai">Kirim</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
...
<?php
    ...
    header('Location: ../index.php'); // Misalnya, halaman "Unauthorized Access"
    exit();
}
?>