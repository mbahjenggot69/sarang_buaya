<?php
require '../pages2/function.php';
require '../pages2/cek.php';
...
?>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark" style="padding-top: 30px; padding-bottom: 35px;">
            <a href="../pages1/index.php"><img src="../assets/img/Logo_SIMERA_2.png" width="80px" alt="Logo" /></a>
            <!-- Sidebar Toggle-->
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="../pages2/main.php">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="../pages2/manajemen.php">Peralatan Lab</a>
                                    <a class="nav-link" href="../pages2/pemesanan.php">Pemesanan Lab</a>
                                    <a class="nav-link" href="../pages2/history.php">History</a>
