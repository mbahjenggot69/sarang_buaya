                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $peralatan = [
                                        "adm_anatomi/plt_anatomi.php",
                                        "adm_hidrodinamika/plt_hidrodinamika.php",
                                        "adm_komputasi/plt_komputasi.php",
                                        "adm_multimedia/plt_multimedia.php",
                                        "adm_termofluida/plt_termofluida.php"
                                    ];

                                    $jadwal = [
                                        "adm_anatomi/jdw_anatomi.php",
                                        "adm_hidrodinamika/jdw_hidrodinamika.php",
                                        "adm_komputasi/jdw_komputasi.php",
                                        "adm_multimedia/jdw_multimedia.php",
                                        "adm_termofluida/jdw_termofluida.php"
                                    ];
