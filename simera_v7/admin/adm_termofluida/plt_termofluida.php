...
if (!isset($_SESSION['log']) || $_SESSION['role'] !== 'admin') {
    ...
    $isAdminLab = ($username === 'admin_lab5');
?>
    ...
    <head>
        ...
        <title>Peralatan Laboratorium Termofluida - Sistem Informasi Manajemen Ruangan</title>
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Peralatan Laboratorium Termofluida</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from plt_termofluida");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-warning" name="editstok_ter">Edit</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="hapusstok_ter">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
        ...
        <script src="../../sjs/datatables-simple-demo.js"></script>
    </body>
    <!-- The Modal -->
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" name="tambahstok_ter">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
