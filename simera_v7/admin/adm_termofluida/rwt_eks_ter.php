                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="pjm_pra_tere.php">Peralatan Dipinjam</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="pjm_eks_tere.php">Peralatan Dipinjam</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseMenus" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="rwt_eks_tere.php">Jadwal & Modul</a>
                                    <a class="nav-link" href="rwt_pra_tere.php">Peralatan Praktikum</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Riwayat Eksperimen Laboratorium Termofluida</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from rwt_eks_ter");
                                        $no = 1;
