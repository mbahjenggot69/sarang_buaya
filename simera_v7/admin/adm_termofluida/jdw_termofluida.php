...
if (!isset($_SESSION['log']) || $_SESSION['role'] !== 'admin') {
    ...
    $isAdminLab5 = ($username === 'admin_lab5');
?>
    ...
    <head>
        ...
        <title>Jadwal Laboratorium Termofluida - Sistem Informasi Manajemen Ruangan</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Jadwal Laboratorium Termofluida</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from jdw_termofluida");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="selesaijadwal_ter">Selesai</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <button type="submit" class="btn btn-primary" name="tambahjadwal_ter">Tambah</button>
                    </form>
                </div>
            </div>
        </div>
