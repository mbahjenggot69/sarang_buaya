...
?>
    ...
    <head>
        ...
        <title>Peralatan Praktikum Anatomi - Sistem Informasi Manajemen Ruangan</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Peralatan Praktikum Anatomi Dipinjam</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from plt_anatomi where status = 1");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="selesaipinjam_ana">Selesai</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
