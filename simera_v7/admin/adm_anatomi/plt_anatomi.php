...
// Periksa apakah sesi diatur dan apakah pengguna adalah admin_lab1
if (!isset($_SESSION['log']) || $_SESSION['role'] !== 'admin') {
    ...
    $isAdminLab = ($username === 'admin_lab1');
?>
    ...
    <head>
        ...
        <title>Peralatan Laboratorium Anatomi - Sistem Informasi Manajemen Ruangan</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="plt_anatomi.php">Manajemen & Pinjam</a>
                                    <a class="nav-link" href="pjm_pra_ana.php">Peralatan Dipinjam</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="mdl_anatomi.php">Modul</a>
                                    <a class="nav-link" href="jdw_anatomi.php">Jadwal & Modul</a>
                                    <a class="nav-link" href="pjm_eks_ana.php">Peralatan Dipinjam</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseMenus" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="rwt_eks_ana.php">Jadwal & Modul</a>
                                    <a class="nav-link" href="rwt_pra_ana.php">Peralatan Praktikum</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Peralatan Laboratorium Anatomi</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from plt_anatomi");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-warning" name="editstok_ana">Edit</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="hapusstok_ana">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" name="tambahstok_ana">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
