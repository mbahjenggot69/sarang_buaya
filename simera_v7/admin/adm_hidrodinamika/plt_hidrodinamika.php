...
if (!isset($_SESSION['log']) || $_SESSION['role'] !== 'admin') {
    ...
    $isAdminLab = ($username === 'admin_lab2');
?>
    ...
    <head>
        ...
        <title>Peralatan Laboratorium Hidrodinamika - Sistem Informasi Manajemen Ruangan</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Peralatan Laboratorium Hidrodinamika</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from plt_hidrodinamika");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-warning" name="editstok_hid">Edit</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="hapusstok_hid">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" name="tambahstok_hid">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
