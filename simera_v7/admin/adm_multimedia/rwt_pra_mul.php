...
?>
    ...
    <head>
        ...
        <title>Riwayat Praktikum Multimedia - Sistem Informasi Manajemen Ruangan</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Riwayat Praktikum Multimedia</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from rwt_pra_mul");
                                        $no = 1;
