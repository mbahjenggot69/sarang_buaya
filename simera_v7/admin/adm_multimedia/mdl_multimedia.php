...
if (!isset($_SESSION['log']) || $_SESSION['role'] !== 'admin') {
    ...
    // Periksa apakah pengguna adalah admin_lab4
...
?>
    ...
    <head>
        ...
        <title>Jadwal Laboratorium Multimedia - Sistem Informasi Manajemen Ruangan</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Modul Laboratorium Multimedia</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from mdl_multimedia");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="hapusmodul_mul">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <button type="submit" class="btn btn-primary" name="tambahmodul_mul">Tambah</button>
                    </form>
                </div>
            </div>
        </div>
