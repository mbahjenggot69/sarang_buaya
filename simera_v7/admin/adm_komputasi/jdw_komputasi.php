...
if (!isset($_SESSION['log']) || $_SESSION['role'] !== 'admin') {
    ...
    $isAdminLab3 = ($username === 'admin_lab3');
?>
    ...
    <head>
        ...
        <title>Jadwal Laboratorium Komputasi - Sistem Informasi Manajemen Ruangan</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="plt_komputasi.php">Manajemen & Pinjam</a>
                                    <a class="nav-link" href="pjm_pra_kom.php">Peralatan Dipinjam</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="mdl_komputasi.php">Modul</a>
                                    <a class="nav-link" href="jdw_komputasi.php">Jadwal & Modul</a>
                                    <a class="nav-link" href="pjm_eks_kom.php">Peralatan Dipinjam</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseMenus" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="rwt_eks_kom.php">Jadwal & Modul</a>
                                    <a class="nav-link" href="rwt_pra_kom.php">Peralatan Praktikum</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Jadwal Laboratorium Komputasi</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from jdw_komputasi");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="selesaijadwal_kom">Selesai</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post">
                        ...
                        <button type="submit" class="btn btn-primary" name="tambahjadwal_kom">Tambah</button>
                    </form>
                </div>
            </div>
        </div>
