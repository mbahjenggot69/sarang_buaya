...
if (!isset($_SESSION['log']) || $_SESSION['role'] !== 'admin') {
    ...
    $isAdminLab = ($username === 'admin_lab3');
?>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from plt_komputasi");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <button type="submit" class="btn btn-warning" name="editstok_kom">Edit</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="hapusstok_kom">Hapus</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
            ...
            <div class="modal-content">
                ...
                <form method="post">
                    <div class="modal-body">
                        ...
                        <br>
                        <button type="submit" class="btn btn-primary" name="tambahstok_kom">Tambah</button>
                    </div>
                </form>
            </div>
        </div>
