...
?>
    ...
    <head>
        ...
        <title>Peralatan Praktikum Komputasi - Sistem Informasi Manajemen Ruangan</title>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="plt_komputasi.php">Pinjam</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Peralatan Praktikum Komputasi Dipinjam</h1>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambilsemuadatastok = mysqli_query($conn, "select * from plt_komputasi where status = 1");
                                        $no = 1;
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <form method="post">
                                                            <div class="modal-body">
                                                                ...
                                                                <br>
                                                                <button type="submit" class="btn btn-danger" name="selesaipinjam_kom">Selesai</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
