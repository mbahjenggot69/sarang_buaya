                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if ($status == 1) : ?>
                                                        <button type="button" class="btn btn-info" disabled>Dipinjam</button>
                                                    <?php else : ?>
                                                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#pinjam<?= $id; ?>">Pinjam</button>
                                                    <?php endif; ?>
                                                </td>
                                            </tr>
                                            <!-- The Modal Edit -->
