                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="pjm_ter_pra.php">Peralatan Dipinjam</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="pjm_ter_eks.php">Peralatan Dipinjam</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseMenus" aria-labelledby="headingThree" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="rwt_ter_eks.php">Jadwal & Modul</a>
                                    <a class="nav-link" href="rwt_ter_pra.php">Peralatan Praktikum</a>
                                </nav>
                            </div>
