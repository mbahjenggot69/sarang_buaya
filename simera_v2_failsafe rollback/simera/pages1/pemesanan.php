                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td><?= $bataswaktu; ?></td>
                                                <td>
                                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#selesai<?= $idalat; ?>">
                                                        Selesai
                                                    </button>
                                                </td>
                                            </tr>
                                            <!-- The Modal Selesai -->
                                            <div class="modal fade" id="selesai<?= $idalat; ?>">
